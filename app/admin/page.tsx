                  ...
                  <div className="flex flex-col sm:flex-row justify-between sm:items-start border-b pb-3 mb-3 gap-4">
                    <div className="flex items-start space-x-3 w-full">
                      ...
                      <div className="flex-grow">
                        <p className={`font-bold text-lg ${pedido.estado === 'entregado' ? 'line-through text-gray-500' : 'text-gray-900'}`}>{pedido.cliente}</p>
                        <p className={`text-sm ${pedido.estado === 'entregado' ? 'text-gray-500' : 'text-gray-600'}`}>{pedido.telefono}</p>
                      </div>
                    </div>
